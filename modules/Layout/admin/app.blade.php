...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'MIKEINTOSH SYSTEMS'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('MIKEINTOSH SYSTEMS by')}} <a href="{{__('https://www.mikeintoshsys.com')}}" target="_blank">{{__('MIKEINTOSH SYSTEMS')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://www.mikeintoshsys.com')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://m.me/mikeintoshsystems')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
