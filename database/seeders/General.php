...
<a href="mailto:contact@bookingcore.test">contact@bookingcore.test</a>',
                ...
                [
                    ...
                    'val'   => 'Copyright © 2022 by MIKEINTOSH SYSTEMS',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => "<!DOCTYPE html><html><head></head><body><h3>MIKEINTOSH SYSTEMS</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                    'group' => "general",
                ],
                [
...
<p>This document was last updated on October 6, 2020</p>';
        ...
        DB::table('core_settings')->insert([
                ...
                [
                    'name'  => "email_header",
                    'val'   => '<h1 class="site-title" style="text-align: center">MIKEINTOSH SYSTEMS</h1>',
                    'group' => "general",
                ],
                [
                    'name'  => "email_footer",
                    'val'   => '<p class="" style="text-align: center">&copy; 2019 MIKEINTOSH SYSTEMS. All rights reserved</p>',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    <p>Thank you for signing up with MIKEINTOSH SYSTEMS! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>MIKEINTOSH SYSTEMS</p>',
                    'group' => "user",
                ],
                [
        ...
        DB::table('core_settings')->insert([
                ...
                [
                    ...
                    'val'   => "<p><span style=\"font-size: 14pt;\"><strong>MIKEINTOSH SYSTEMS Company</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
